...
if [ $map_pop != 'M2' ]; then
	...
	parmut_sample=$f0/m2/mutated_genome.fa
	parpol_sample=$f0/m2/lab.fa
...
my_operation_mode=A
{
	python2 $location/an_scripts/variants-operations.py -a $f1/filtered_variants.va -b $f0/m2/lab.va -c $f1/variants.va -mode $my_operation_mode -primary 1  2>> $my_log_file
