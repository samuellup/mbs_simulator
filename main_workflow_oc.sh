...
# Filter .va file
{
	python2 $location/an_scripts/variants-filter.py -a $f1/raw_variants.va -b $f1/filtered_variants.va -step 3 -fasta $f0/$in_fasta -dp_min 10 -qual_min 40  2>> $my_log_file
